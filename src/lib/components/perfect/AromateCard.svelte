...
{#if aromate}
	<div class="rounded-lg border border-blue-700 bg-blue-800/50 p-4">
		<div class="mb-2 text-xs text-blue-400">{$_('perfect.plan.aromate')}</div>
		<div class="flex items-center gap-3">
			...
			<div class="relative flex-1 pr-24">
				...
				<button
					type="button"
					class="absolute right-0 top-1/2 flex -translate-y-1/2 cursor-pointer flex-col items-center gap-1 rounded-md border border-blue-600/60 bg-blue-900/30 px-2 py-1 text-sm font-semibold text-blue-100 transition-colors hover:border-blue-400/70 hover:text-white"
